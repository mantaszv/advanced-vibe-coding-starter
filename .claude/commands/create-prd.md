...
- `payment-guard`: {YES/NO — does it touch payment flow}
- `db-migration-guard`: {YES/NO — are there DB migrations}
- `language-guard`: {YES/NO — is there UI text}
- `file-size-guard`: {YES/NO — are large files affected}
